...
export const AVAILABLE_MODEL_KEYS = [
  // NOTE: removed from AWS Bedrock (EOL / no longer in the model catalog as of Jul 2026):
  // 'claude-v4-opus', 'claude-v3-opus', 'claude-v3.7-sonnet', 'mistral-large-2',
  // 'claude-v3.5-sonnet', 'claude-v3.5-sonnet-v2', 'claude-v3.5-haiku', 'claude-v3-haiku',
  // 'claude-v4-sonnet', 'llama3-2-1b-instruct', 'llama3-2-3b-instruct',
  // 'llama3-2-11b-instruct', 'llama3-2-90b-instruct', 'mixtral-8x7b-instruct'
  'claude-v4.1-opus',
  'claude-v4.5-opus',
  'claude-v4.5-sonnet',
  'claude-v4.5-haiku',
